...
(function(){
  ...
  var BG_FS = [
    ...
    '  vec3 col = base + (uC1 * a1 + uC2 * a2) * 0.36;',
  ...
  var FX = [['#1F6BFF', '#22D3FF'], ['#22D3FF', '#3B4DFF'], ['#3D6BFF', '#8A5CFF'], ['#5B6BFF', '#22D3FF'], ['#14B8FF', '#2F5BFF'], ['#1F6BFF', '#22D3FF']].map(function(a){ return [hex(a[0]), hex(a[1])]; });
